...
if(type(args.noshow_results) == type(None)):
    show_results = False         # Defaults to Frue
else:
...
for image_path in images:
    ...
    if(store_csv):
        ...
        for obj in detections:
            detection_str += obj[0] + "," + str(obj[1]) + "," + str(obj[2]) + "," + str(obj[3]) + "," + str(obj[4]) + "," + str(obj[5]) + "\n"
